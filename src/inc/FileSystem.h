...
public:
	...
	static const int INODE_ZONE_SIZE = 127 - INODE_ZONE_START_SECTOR;		/* 磁盘上外存Inode区占据的扇区数 */

	static const int DATA_ZONE_START_SECTOR = 127;		/* 数据区的起始扇区号 */
	static const int DATA_ZONE_END_SECTOR = 65536 - 1;	/* 数据区的结束扇区号 */
	static const int DATA_ZONE_SIZE = 65536 - DATA_ZONE_START_SECTOR;	/* 数据区占据的扇区数量 */
